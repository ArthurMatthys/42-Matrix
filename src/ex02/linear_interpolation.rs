...
mod tests {
    ...
    fn test_lerp_scalar_00() {
        assert_eq!(_lerp(0., 1., 0.), 0.);
    }
    #[test]
    fn test_lerp_scalar_01() {
        assert_eq!(_lerp(0., 1., 1.), 1.);
    }
    #[test]
    fn test_lerp_scalar_02() {
        assert_eq!(_lerp(0., 1., 0.5), 0.5);
    }
    #[test]
    fn test_lerp_scalar_03() {
        assert_eq!(_lerp(21., 42., 0.3), 27.3);
    }
    #[test]
    fn test_lerp_scalar_04() {
        assert_eq!(_lerp(0., 42., 0.5), 21.);
    }
    #[test]
    fn test_lerp_scalar_05() {
        assert_eq!(_lerp(-42., 42., 0.5), 0.);
    }
    #[test]
    fn test_lerp_r00() {
        let u = Vector([2., 1.]);
    ...
    fn test_lerp_complex_00() {
        assert!(_lerp(Complex(1., 0.), Complex(0., 1.), Complex(0.5, 0.)) == Complex(0.5, 0.5))
    }
    #[test]
